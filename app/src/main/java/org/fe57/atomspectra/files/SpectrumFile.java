...
public abstract class SpectrumFile {
    ...
    public static Pair<OutputStream, String> prepareOutputStream(@NonNull Context context, String folder, long date, @NonNull String prefix, boolean addPrefix, String suffix, @NonNull String extension, @NonNull String mimeType, boolean addDate, boolean addTime, boolean removeFirst) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            try {
                docStream = context.getContentResolver().openOutputStream(spectrumFile.getUri());
            } catch (Exception e) {
                return null;
            }
            ...
            try {
                docStream = new FileOutputStream(filename);
            } catch (Exception e) {
                return null;
            }
            Log.d(TAG, spectrumFileName);
        }
        return new Pair<>(docStream, spectrumFileName);
    }
    ...
    abstract public boolean saveSpectrum(@NonNull OutputStream docStream, Context context);
}
