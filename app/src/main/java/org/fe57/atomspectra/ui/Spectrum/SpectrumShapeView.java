...
public class SpectrumShapeView extends View {
	...
	private SpectrumViewModel Model = null;
	...
	public SpectrumShapeView(Context context) {
		super(context);
	}

	public SpectrumShapeView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SpectrumShapeView(Context context, AttributeSet attrs, int defStyle) {
...
//			}
	...
	public void setModel(SpectrumViewModel model) {
		Model = model;
	}
