...
public class ConfigurationShapeView extends View {
	...
	public ConfigurationShapeView(Context context) {
		super(context);
	}

	public ConfigurationShapeView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public ConfigurationShapeView(Context context, AttributeSet attrs, int defStyle) {
